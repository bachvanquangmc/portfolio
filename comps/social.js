...
const MyImage = styled.img`
  width: 1.75rem;
  height: 1.75rem;
  filter: invert(100%) sepia(12%) saturate(0%) hue-rotate(45deg)
...
`;
export default function Social({ background = "#373351" }) {
  ...
  return (
    <MainCont>
      ...
      <Card
        background={theme === "dark" ? "#FBBF78" : "#373351"}
        onClick={() => setTheme("dark")}
      >
        <MyImage src="/night.svg" />
      </Card>
      <Card
        background={theme === "default" ? "#FBBF78" : "#373351"}
